...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/15 14:44:50 by ihajouji          #+#    #+#             */
/*   Updated: 2024/04/21 18:06:07 by ihajouji         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_vars(t_mlx_data *data)
{
	...
	data->move = 0;
	data->enemy_check = check_enemy(data->map, data->w_height);
}
...
int	main(int ac, char **av)
{
	...
	if (data->enemy_check == 1)
		mlx_loop_hook(data->mlx_ptr, move, data);
	else if (data->enemy_check == 0)
		mlx_loop_hook(data->mlx_ptr, turn_s2, data);
